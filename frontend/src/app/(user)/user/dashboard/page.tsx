    ...
    <div className="p-4 lg:p-8 space-y-6 lg:space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-5 border-b border-slate-50 flex justify-between items-center">
          <h3 className="font-headline text-lg font-bold text-slate-900">My Loan Applications</h3>
          <Link href="/user/applications"><span className="text-xs font-bold text-[var(--color-primary)] hover:underline cursor-pointer">View All →</span></Link>
        </div>
        {loans.length === 0 ? (
