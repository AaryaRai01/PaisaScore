  ...
  return (
    <div className="p-8 space-y-8">
      <header className="flex justify-between items-end">
        <div>
          <h2 className="font-headline text-3xl font-extrabold text-slate-900">Reports &amp; Analytics</h2>
          <p className="text-slate-500 mt-1">Live portfolio performance — refreshes every 15s</p>
          {mounted && (
            <div className="hidden print:block text-xs text-slate-400 mt-2 font-bold uppercase tracking-widest">
              Generated by PaisaScore Financial Architect · {new Date().toLocaleString()}
            </div>
          )}
        </div>
